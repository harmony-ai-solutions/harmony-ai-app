...
-- 1. Add image support
ALTER TABLE chat_messages ADD COLUMN image_data BLOB;
...
ALTER TABLE chat_messages ADD COLUMN vl_model_embedding BLOB;

-- 2. AUDIO: Replace audio_file with blob+mime_type
ALTER TABLE chat_messages DROP COLUMN audio_file;
ALTER TABLE chat_messages ADD COLUMN audio_data BLOB;
